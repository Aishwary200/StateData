export const myObj = [
    {
        ...
        lan: 'Telugu', pop: '5.44 Crores', cm: 'Shri YS Jagan Mohan Reddy',
        gov: 'Shri Biswa Bhusan Harichandan', sf: 'Jasmine',
        sa: 'Blackbuck'
    }, {
        stateName: "Arunachal Pradesh", capital: "Itanagr",
        Area: '83,743 km²', date: '20 Feb. 1987', food: 'Thukpa',
        site: 'Tawang, Bombdila, Lohit District, Ziro',
        lan: 'Nishi', pop: '15.92 Lakhs', cm: '	Shri Pema Khandu',
        gov: 'Brig. (Dr.) B. D. Mishra (Retd.)', sf: 'Foxtail Orchid',
        sa: 'Hoolock Gibbon'
    }, {
        ...
        lan: 'Assamese', pop: '3.60 Crores', cm: 'Shri Himanta Biswa Sarma',
        gov: 'Prof. Jagdish Mukhi', sf: 'Foxtail Orchid',
        sa: 'One-horned rhinoceros'
    }, {
        ...
        lan: 'Bhojpuri, Magahi, Maithili', pop: '12.70 Crores', cm: 'Shri Nitish Kumar',
        gov: 'Shri Phagu Chauhan', sf: 'Orchid Tree (Kachnar)',
        sa: 'Gaur'
    }, {
        stateName: "Chhattisgarh", capital: "Raipur",
        Area: '135,191 km²', date: '1 Nov. 2000', food: 'Chila',
        site: 'Chittrakote WaterFalls, Bhoramdeo Temple, Maikal Hills, Kanger Vally National Park',
        lan: 'Chhattisgarhi', pop: '2.98 Crores', cm: 'Shri Bhupesh Baghel',
        gov: 'Sushri Anusuiya Uikey', sf: "Lady's Slipper",
        sa: 'Wild water buffalo'
    }, {
        ...
        lan: 'Gujarati', pop: '6.43 Crores', cm: 'Shri Vijaybhai R. Rupani',
        gov: 'Shri Acharya Dev Vrat', sf: 'African Marigold',
        sa: 'Asiatic lion'
    }, {
    ...
    },
    {
        ...
        lan: 'Malayalam', pop: '3.60 Crores', cm: 'Shri Pinarayi Vijayan',
        gov: 'Shri Arif Mohammed Khan', sf: 'Golden shower tree',
        sa: 'Indian elephant'
    },
    {
    ...
    },
    {
        ...
        lan: 'Marathi', pop: '12.43 Crores', cm: 'Shri Uddhav Thackeray',
        gov: 'Shri Bhagat Singh Koshyari', sf: 'Jarul',
        sa: 'Indian giant squirrel'
    },
    {
        stateName: "Manipur", capital: "Imphal",
        Area: '22,327 km²', date: '21 Jan. 1972', food: 'Kangshoi',
        site: 'Sri Sri Govindajee Temple, Loktak Lake, Sirohi National Park, Manipur State Museum',
        lan: 'Meitei', pop: '32 Lakhs', cm: 'Shri N. Biren Singh',
        gov: 'Dr. Najma Heptulla', sf: 'Siroi lily',
        sa: 'Sangai'
    },
    {
        stateName: "Meghalaya", capital: "Shillong",
        Area: '22,429 km²', date: '21 Jan. 1972', food: 'Jadoh',
        site: 'Butterfly Museum, Umium Lake, Mawsmai Caves, Elephant Falls',
        lan: 'Khasi, Jaintia, Garo, English', pop: '34 Lakhs', cm: 'Shri Conrad Kongkal Sangma',
        gov: 'Shri Satya Pal Malik', sf: "Lady's slipper",
        sa: 'Clouded leopard'
    },
    {
    ...
    },
    {
        ...
        Area: '16,579 km²', date: '1 Dec. 1963', food: 'Pork with Bamboo Shoot',
        site: 'Naga Heritage Village, Kohima War Cemetery, Kisama Heritage Village, Kohima Museum',
        lan: 'Nagamese', pop: '23 Lakhs', cm: 'Shri Neiphiu Rio',
        gov: 'Shri R. N. Ravi', sf: 'Rhododendron',
        sa: 'Bos gaurus(Mithun)'
    },
    {
        ...
        lan: 'Odia', pop: '4.69 Crores', cm: 'Shri Naveen Patnaik',
        gov: 'Prof. Ganeshi Lal', sf: 'Ashoka',
        sa: 'Sambar'
    },
    {
        stateName: "Punjab", capital: "Chandigarh",
        Area: '50,362 km²', date: '1 Nov. 1956', food: 'Makki Di Roti & Sarson Da Saag',
        site: 'Golden Temple (Harmandir Sahib), Akal Takht, Rangla Punjab Haveli, Bhatinda Zoological Park',
        lan: 'Punjabi', pop: '3 Crores', cm: 'Shri Capt. Amarinder Singh',
        gov: 'Shri V.P. Singh Badnore', sf: 'Gladiolus',
        sa: 'Blackbuck'
    },
    {
        stateName: "Rajasthan", capital: "Jaipur",
        Area: '342,239 km²', date: '1 Nov. 1956', food: 'Dal Baati Churma',
        site: 'Jaipur – The Pink City, Gadisar Lake, Hawa Mahal, Thar Desert',
        lan: 'Hindi, Rajasthani', pop: '8.25 Crores', cm: 'Shri Ashok Gehlot',
        gov: 'Shri Kalraj Mishra', sf: 'Rohira',
        sa: 'Chinkara'
    },
    {
        stateName: "Sikkim", capital: "Gangtok",
        Area: '7,096 km²', date: '16 May. 1975', food: 'Momo',
        site: 'Gangtok, Tsomgo Lake, Ranka Monastery, Do Drul Chorten Stupa',
        lan: 'Nepali, English, Hindi, Lepcha', pop: '7 Lakhs', cm: 'Shri PS Golay',
        gov: 'Shri Ganga Prasad', sf: 'Noble orchid',
        sa: 'Red panda'
    },
    {
        ...
        lan: 'Tamil', pop: '7.85 Crores', cm: 'Shri M. K. Stalin',
        gov: 'Shri Banwarilal Purohit', sf: 'Glory lily',
        sa: 'Nilgiri tahr'
    }, {
        ...
        lan: 'Telugu', pop: '3.98 Crores', cm: 'Shri K Chandrasekhar Rao',
        gov: 'Dr. Tamilisai Soundararajan', sf: 'Tangedu Puvvu',
        sa: 'Spotted deer'
    },
    {
        ...
        lan: 'Hindi, Awadhi, Brij', pop: '24 Crores', cm: '	Shri Yogi Aditya Nath',
        gov: 'Smt. Anandiben Patel', sf: 'Palash',
        sa: 'Swamp deer'
    }, {
        ...
        lan: 'Bengali', pop: '10 Crores', cm: 'Km. Mamata Banerjee',
        gov: 'Shri Jagdeep Dhankhar', sf: 'Shephali',
        sa: 'Fishing Cat'
    }, {
        ...
        gov: 'Admiral D K Joshi (Lieutenant Governor)', sf: 'Andaman Pyinma',
        sa: 'Dugong(Sea Cow)'
    }, {
        ...
        gov: 'Shri.V.P. Singh Badnore (Administrator)', sf: 'Palash',
        sa: 'Indian Gray Mongoose'
    }, {
        ...
        gov: 'Shri Praful Patel (Administrator)', sf: 'Not yet designated',
        sa: 'Not yet designated'
    },
    {
        ...
        gov: 'Shri Anil Baijal (Lieutenant Governor)', sf: 'Alfalfa',
        sa: 'Nilgai'
    }, {
        ...
        gov: 'Shri Manoj Sinha (Lieutenant Governor)', sf: 'Common rhododendron',
        sa: 'Kashmir stag(Hangul)'
    }, {
        ...
        gov: 'Shri Radha Krishna Mathur (Lieutenant Governor)', sf: 'Not yet designated',
        sa: 'Domestic yak'
    }, {
        ...
        gov: 'Shri Praful Patel (Administrator)', sf: 'Neelakurinji',
        sa: 'Butterfly fish'
    }, {
        ...
        gov: 'Dr. Tamilisai Soundararajan (Addl. Charge) (Lieutenant Governor)', sf: "Cannonball tree's flower",
        sa: 'Indian palm squirrel'
    },
]